                  ...
                  <Form>
                    <Form.Row>
                      <Form.Group as={Col} controlId="formGridEmail">
                        ...
                        <Form.Control type="text" placeholder="Aadhar Number" id="aadhar" onChange={props.onInputChange}/>
                      </Form.Group>
                    ...
                    <Form.Row>
                      <Form.Group as={Col} controlId="formGridAddress1">
                        ...
                        <Form.Control placeholder="Mother Name" id="mother_name" onChange={props.onInputChange}/>
                      </Form.Group>
                    
                      <Form.Group as={Col} controlId="formGridAddress2">
                        <Form.Label>Father Name</Form.Label>
                        <Form.Control placeholder="Father Name" id="father_name" onChange={props.onInputChange}/>
                      </Form.Group>
                    </Form.Row>
